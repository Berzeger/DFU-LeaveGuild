...
namespace Berzeger
{
    public class GuildServicePopupWindow : DaggerfallQuestPopupWindow, IMacroContextProvider
    {
        ...
        public GuildServicePopupWindow(IUserInterfaceManager uiManager, StaticNPC npc, FactionFile.GuildGroups guildGroup, int buildingFactionId)
            : base(uiManager)
        {
        ...
        protected override void Setup()
        {
            ...
            mainPanel.Position = new Vector2(0, 45);
        ...
        {
            private GuildServicePopupWindow parent;
            public GuildServiceMacroDataSource(GuildServicePopupWindow guildServiceWindow)
            {
